...
public sealed class ToLowerTransformationHandlerTests
{
    private readonly ToLowerTransformationHandler _handler = new();
    ...
    public void Apply_LowercasesStringWithoutChangingWhitespace(string input, string expected)
    {
    ...
    {
        Assert.Equal(TransformationType.ToLower, _handler.Type);
    }
